...
use phpmq\helpers\ArrayHelper;
use phpmq\helpers\Inflector;
use Exception;
...
class Connection extends BaseObject
{
    ...
    private function redirect($redirect, $command, $params)
    {
        ...
        throw new Exception('No hostname found in redis redirect (MOVED): ' . json_encode($redirect));
    }
}
